            ...
            <div class="span6">
                <div class="search">
                    <form id="goodsSearchForm" action="${ctx}/goods/search" method="get">
                        <input name="keyword" class="keyword" value="" autocomplete="off"
                    ...
                    [#list navigations as navigation]
                        <dd>
                            <a href="${ctx}${navigation.url}"
                               [#if navigation.isBlankTargert == -1]target="_blank" [/#if]>${navigation.name}</a>
                        </dd>
                    [/#list]
                [/@navigation_list]
                                    ...
                                    [#list productCategories as productCategory]
                                        <dl class="clearfix [#if !productCategory_has_next]last[/#if]">
                                            ...
                                            [@product_category_children_list parentId=productCategory.id]
                                                [#list productCategories as productCategory]
                                                    <dd>
                                                        <a href="${ctx}/goods/list/${productCategory.id}">${productCategory.name}</a>[#if productCategory_has_next]
                                                        |[/#if]
                                                    </dd>
                                                [/#list]
                                            [/@product_category_children_list]
                ...
                <ul>
                    <li>
                        <a href="" title="苹果 iPhone 5s" target="_blank">
                            ...
                            <strong>4200</strong>
                            <img src="/upload/image/blank.gif"
        ...
        <div class="span12">
            <div class="bottomAd">
                <ul>
                    <li>
                        <a href="#">
                            <img src="http://image.demo.shopxx.net/4.0/201501/e44f5fe1-523d-4ba5-af75-c60ff9125ed4.jpg"
                                 alt="数码相机" title="数码相机"/>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="http://image.demo.shopxx.net/4.0/201501/b955bbb2-b9ad-4e6b-9dc2-5159a18cdaee.jpg"
                                 alt="智能手表" title="智能手表"/>
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img src="http://image.demo.shopxx.net/4.0/201501/dff83843-d61a-4406-9a00-1d5efe7fbe38.jpg"
                                 alt="智能手机" title="智能手机"/>
                        </a>
                    </li>
                </ul>
                ...
                <ul>
                    <li>
                        <a href="#" target="_blank">
                            <img src="http://image.demo.shopxx.net/b2b2c/5.0/201601/1c675feb-e488-4fd5-a186-b28bb6de445a.gif"
                                 alt="SHOP++">
                        </a>
                    </li>
                    <li>
                        <a href="http://www.alipay.com" target="_blank">
                            <img src="http://image.demo.shopxx.net/b2b2c/5.0/201601/ae13eddc-25ac-427a-875d-d1799d751076.gif"
                                 alt="支付宝">
                        </a>
                    </li>
                    <li>
                        <a href="http://www.tenpay.com" target="_blank">
                            <img src="http://image.demo.shopxx.net/b2b2c/5.0/201601/adaa9ac5-9994-4aa3-a336-b65613c85d50.gif"
                                 alt="财付通">
                        </a>
                    </li>
                    <li>
                        <a href="https://www.95516.com" target="_blank">
                            <img src="http://image.demo.shopxx.net/b2b2c/5.0/201601/41c18c8d-f69a-49fe-ace3-f16c2eb07983.gif"
                                 alt="中国银联">
                        </a>
                    </li>
                    <li>
                        <a href="http://www.kuaidi100.com" target="_blank">
                            <img src="http://image.demo.shopxx.net/b2b2c/5.0/201601/ea46ca0a-e8f0-4e2c-938a-5cb19a07cb9a.gif"
                                 alt="快递100">
                        </a>
                    </li>
                    <li>
                        <a href="http://www.cnzz.com" target="_blank">
                            <img src="http://image.demo.shopxx.net/b2b2c/5.0/201601/e12f226b-07f9-4895-bcc2-78dbe551964b.gif"
                                 alt="站长统计">
                        </a>
                    </li>
                    <li>
                        <a href="http://down.admin5.com" target="_blank">
                            <img src="http://image.demo.shopxx.net/b2b2c/5.0/201601/fd9d6268-e4e2-41f6-856d-4cb8a49eadd1.gif"
                                 alt="A5下载">
                        </a>
                    </li>
                    <li>
                        <a href="http://www.ccb.com" target="_blank">
                            <img src="http://image.demo.shopxx.net/b2b2c/5.0/201601/6c57f398-0498-4044-80d8-20f6c40d5cef.gif"
                                 alt="中国建设银行">
                        </a>
                    </li>
                </ul>
